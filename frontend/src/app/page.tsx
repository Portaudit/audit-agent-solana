...
export default function Home() {
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100 font-sans px-4 md:px-6 py-3 flex flex-col items-center">
      ...
      <header className="w-full max-w-7xl flex justify-between items-center mb-3">
      ...
      <section className="w-full max-w-7xl text-center mb-3">
        ...
        <p className="text-xs md:text-sm text-slate-400 max-w-2xl mx-auto mb-2">
          Agents get paid only for mathematically verified code. Deterministic validation + Solana sub-second finality.
        </p>
        <div className="inline-block px-3 py-0.5 rounded-full bg-slate-800 border border-slate-700 text-[10px] text-slate-300">
